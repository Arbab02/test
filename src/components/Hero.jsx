    ...
    <section className="text-gray-400 bg-[#000319] body-font">
      <div className="container mx-auto flex px-3 sm:px-5 pt-[3.5rem] md:pt-[5rem] items-center justify-center flex-col max-w-full">
        ...
        <div className="mt-8 flex justify-center space-x-4 text-white">
          <FaLaptopCode className="text-blue-400 lg:text-6xl md:text-6xl sm:text-6xl transform hover:scale-110 transition-transform duration-300" title="Coding" />
          <FaCloud className="text-blue-300 lg:text-6xl md:text-6xl sm:text-6xl transform hover:scale-110 transition-transform duration-300" title="Cloud Technologies" />
          <FaRobot className="text-green-400 lg:text-6xl md:text-6xl sm:text-6xl transform hover:scale-110 transition-transform duration-300" title="Automation" />
          <SiNextdotjs className="text-gray-300 lg:text-6xl md:text-6xl sm:text-6xl transform hover:scale-110 transition-transform duration-300" title="Next.js" />
          <FaCode className="text-purple-400 lg:text-6xl md:text-6xl sm:text-6xl transform hover:scale-110 transition-transform duration-300" title="Development" />
        </div>
      </div>
    </section>
  );
